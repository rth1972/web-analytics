...
></script>`;
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4" onClick={onClose}>
      <div className="w-full max-w-2xl rounded-2xl border border-[var(--border)] bg-[var(--card)] p-6" onClick={e => e.stopPropagation()}>
        ...
        <div className="mb-4 rounded-lg border border-[var(--border)] bg-[var(--background)]">
          ...
          <pre className="overflow-x-auto p-4 text-xs leading-relaxed"><code>{snippet}</code></pre>
        </div>
        ...
        <div className="rounded-lg border border-[var(--border)] bg-[var(--background)]">
          ...
          <pre className="overflow-x-auto p-4 text-xs leading-relaxed"><code>{jsSnippet}</code></pre>
        </div>
...
export default function WebsitesPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      {showAdd && (
        <div className="rounded-xl border border-[var(--border)] bg-[var(--card)] p-6">
          ...
          <div className="flex flex-wrap gap-3">
            <input type="text" placeholder="Name (e.g. My Blog)" value={name} onChange={e => setName(e.target.value)}
            ...
            <input type="text" placeholder="Domain (e.g. myblog.com)" value={domain} onChange={e => setDomain(e.target.value)}
              className="flex-1 min-w-[160px] rounded-lg border border-[var(--border)] bg-[var(--background)] px-3 py-2 text-sm outline-none focus:border-[var(--primary)]"
      ...
      {snippetFor && <SnippetModal website={snippetFor} onClose={() => setSnippetFor(null)} />}
    </div>
  );
}
